...
void test1() {
    printf("------- L1 Hits  -------\n");
    FILE *input;
    input = open_trace("trace_extra1.txt");
...
void test2() {
    printf("\n------- L2 Hits  -----\n");
    FILE *input;
    input = open_trace("trace_extra2.txt");
    cachesim_init(64, 262144, 8);
    while (next_line(input));
    cachesim_cleanup();
    fclose(input);
...
void test3() {
    ...
    FILE *input;
    input = open_trace("trace_extra3.txt");
    cachesim_init(64, 262144, 8);
    while (next_line(input));
    cachesim_cleanup();
    fclose(input);
...
void test4() {
    ...
    FILE *input;
    input = open_trace("trace_extra4.txt");
    cachesim_init(64, 262144, 8);
    while (next_line(input));
    cachesim_cleanup();
    fclose(input);
...
void test5() {
    ...
    FILE *input;
    input = open_trace("trace_extra5.txt");
